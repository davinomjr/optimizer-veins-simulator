...
\begin{abstract}
\Victor{melhor deixar pra quando o paper estiver completo}
\end{abstract}
...
\Victor{Estou fazendo o pseudocódigo para inserir aqui, não sei se faço em português, ou copio em inglês daquele livro mesmo}
